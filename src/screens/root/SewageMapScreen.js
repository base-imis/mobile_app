...
const SewageMapScreen = ({ navigation }) => {
  ...
  // 'http://202.52.0.116:8080/geosever/imis_base_sample_db/wms?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&FORMAT=image/png&TRANSPARENT=true&LAYERS=imis_base_sample_db:buildings_layer&TILED=true&STYLES=imis_base_sample_db:buildings_layer_none&FORMAT_OPTIONS=dpi:113&WIDTH={width}&HEIGHT={height}&srs=EPSG:900913&BBOX={minX},{minY},{maxX},{maxY}',
  ...
  const [roadWmsLink, setRoadWmsLink] = useState(
    "http://202.52.0.116:8080/geoserver/imis_base_sample_db/wms?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&FORMAT=image%2Fpng&TRANSPARENT=true&LAYERS=imis_base_sample_db%3Aroadlines_layer&TILED=true&STYLES=imis_base_sample_db%3Aroadlines_layer_width&CRS=EPSG%3A3857&FORMAT_OPTIONS=dpi%3A113&WIDTH={width}&HEIGHT={height}&BBOX={minX},{minY},{maxX},{maxY}"
  );

  const [wardWmsLink, setWardWmsLink] = useState(
    "http://202.52.0.116:8080/geoserver/imis_base_sample_db/wms?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&FORMAT=image%2Fpng&TRANSPARENT=true&LAYERS=imis_base_sample_db%3Awards_layer&TILED=true&STYLES=imis_base_sample_db%3Awards_layer_none&CRS=EPSG%3A3857&FORMAT_OPTIONS=dpi%3A113&WIDTH={width}&HEIGHT={height}&BBOX={minX},{minY},{maxX},{maxY}"
  );

  const [sewerWMSLink, setSewerWMSLink] = useState(
    "http://202.52.0.116:8080/geoerver/imis_base_sample_db/wms?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&FORMAT=image/png&TRANSPARENT=true&LAYERS=imis_base_sample_db:sewerlines_layer&TILED=true&STYLES=imis_base_sample_db:sewerlines_layer_size&CRS=EPSG:3857&FORMAT_OPTIONS=dpi:113&WIDTH={width}&HEIGHT={height}&BBOX={minX},{minY},{maxX},{maxY}"
  );
