...
const BuildingMapScreen = ({ navigation }) => {
  ...
  const [wmslinks, setWmslink] = useState(
    "http://202.52.0.116:8080/geoserver/imis_base_sample_db/wms?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&FORMAT=image/png&TRANSPARENT=true&LAYERS=imis_base_sample_db:buildings_layer&TILED=true&STYLES=imis_base_sample_db:buildings_layer_none&FORMAT_OPTIONS=dpi:113&WIDTH={width}&HEIGHT={height}&srs=EPSG:900913&BBOX={minX},{minY},{maxX},{maxY}"
  );
